...
function Login() {
  ...
  <circle cx="50" cy="50" r="20" fill="#ffffff" />
        ...
        <button onClick={
          () => {
            dispatch(login("picak27269@binafex.com", "Abcd1234*", navigate)
          )}
      ...
      <div>
        <button onClick={
          () => {
            dispatch(login("abcd@gmail.com", "Abcd1234*", navigate)
          )}
    ...
    <Template
      title="Welcome Back"
      description1="Learn today. Lead tomorrow. Thrive forever."
