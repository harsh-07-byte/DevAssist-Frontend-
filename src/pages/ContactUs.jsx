    ...
    <div>
        ...
        <div className='lg:w-[40%]'>
            <div className='flex flex-col gap-6 rounded-xl bg-richblack-800 p-4 lg:p-6'>
                <div className='flex flex-col gap-[2px] p-3 text-sm text-richblack-200'>
                    ...
                    <h1 className="text-lg font-semibold text-richblack-5">Contact Us</h1>
                    </div>
                    <p className='font-medium'>Our Team will help you</p>
                    <p className='font-semibold'>DevAssistHelp@DevAssist.com</p>
                </div>
                <div className="flex flex-col gap-[2px] p-3 text-sm text-richblack-200">
                    <div className='flex flex-row items-center gap-3'>
                    ...
                    <p className='font-medium'>You can visit our company Headquarters at the below address</p>
                ...
                <p className='font-semibold'>+91 1234567891</p>
                </div>
            </div>
        </div>
        <div className='lg:w-[60%]'>
            <div className='border border-richblack-600 text-richblack-300 rounded-xl p-7 lg:p-14 flex gap-3 flex-col'>
                ...
                Collaborate with us if you have any idea
                </h1>
                <p className='text-lg font-medium'>Give some info about you and your idea</p>
                <div className='mt-7'>
                    <ContactUsForm/>
                </div>
            </div>
        ...
        <div className='relative mx-auto my-20 flex w-11/12 max-w-maxContent flex-col items-center justify-between gap-8 bg-richblack-900 text-white'>
                    <h1 className='text-center text-4xl font-semibold mt-8'>
                        Reviews of our courses from students who have taken our courses
                    </h1>
                </div>
    </div>
  )
